...
const styles = StyleSheet.create({
  ...
  sponsor: { fontSize: 13, color: 'rgba(255,255,255,0.7)', fontWeight: '500', fontFamily: 'Poppins_500Medium' },
  section: { paddingHorizontal: 16 },
  sectionTitle: { fontSize: 17, fontWeight: '700', fontFamily: 'Poppins_700Bold', color: colors.text, marginBottom: 12 },
  ...
  catName: { fontSize: 15, fontWeight: '600', fontFamily: 'Poppins_600SemiBold', color: colors.text },
