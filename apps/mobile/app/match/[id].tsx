...
const styles = StyleSheet.create({
  ...
  teamInitial: { fontSize: 20, fontWeight: '700', color: '#FFFFFF' },
  teamLabel: { fontSize: 13, fontWeight: '600', color: '#FFFFFF', textAlign: 'center' },
  scoreBlock: { paddingHorizontal: 16 },
  score: { fontSize: 32, fontWeight: '800', letterSpacing: 2 },
  ...
  eventPlayer: { fontSize: 13, fontWeight: '600', color: colors.text },
  ...
  eventMin: { fontSize: 12, fontWeight: '600', color: colors.text },
