...
const styles = StyleSheet.create({
  ...
  emptyText: { fontSize: 16, fontWeight: '600', fontFamily: 'Poppins_600SemiBold', color: colors.textTertiary },
  ...
  tagText: { fontSize: 11, fontWeight: '700', fontFamily: 'Poppins_700Bold', color: colors.primary, letterSpacing: 0.5 },
  cardTitle: { fontSize: 17, fontWeight: '700', fontFamily: 'Poppins_700Bold', color: colors.text, marginBottom: 4 },
