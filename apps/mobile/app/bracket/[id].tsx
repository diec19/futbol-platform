...
const styles = StyleSheet.create({
  ...
  stageTitle: { fontSize: 12, fontWeight: '700', fontFamily: 'Poppins_700Bold', color: '#FFFFFF', textAlign: 'center' },
  ...
  scoreText: { fontSize: 14, fontWeight: '600', fontFamily: 'Poppins_600SemiBold', color: colors.text },
