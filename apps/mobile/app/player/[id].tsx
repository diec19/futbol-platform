...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 20, fontWeight: '700', color: '#FFFFFF', textAlign: 'center' },
  ...
  posText: { fontSize: 12, color: '#FFFFFF', fontWeight: '600' },
  ...
  sanctionType: { fontSize: 13, fontWeight: '600', color: colors.error },
  ...
  eventMin: { fontSize: 12, color: colors.primary, fontWeight: '600' },
