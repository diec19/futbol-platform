...
module.exports = function withReactNativeNodeModulesDir(config) {
  return withAppBuildGradle(config, (cfg) => {
    ...
    // react-native-screens busca REACT_NATIVE_NODE_MODULES_DIR como project ext
    // y luego hace file("${value}/react-native"). En el monorepo, node_modules
    // hoisted esta en la raiz: apps/mobile/android/app -> ../../../node_modules
    const injection = `\n// (config-plugin) Monorepo: node_modules hoisted en la raiz\next.REACT_NATIVE_NODE_MODULES_DIR = rootProject.file("../../../node_modules");\n`;
